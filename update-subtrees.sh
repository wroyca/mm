...
git subtree pull --prefix cairomm git@gitlab.gnome.org:wroy/cairomm.git master --squash
git subtree pull --prefix mm-common git@gitlab.gnome.org:wroy/mm-common.git master --squash
git subtree pull --prefix glibmm git@gitlab.gnome.org:wroy/glibmm.git master --squash
git subtree pull --prefix pangomm git@gitlab.gnome.org:wroy/pangomm.git master --squash
git subtree pull --prefix gtkmm git@gitlab.gnome.org:wroy/gtkmm.git master --squash
