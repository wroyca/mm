...
test_adw_carousel_add_remove (void)
{
  ...
  g_assert_true (carousel.get_nth_page (0)->gobj () ==
                 (GtkWidget*) child2.gobj ());
  g_assert_true (carousel.get_nth_page (1)->gobj () ==
                 (GtkWidget*) child1.gobj ());
  ...
  g_assert_true (carousel.get_nth_page (0)->gobj () ==
                 (GtkWidget*) child2.gobj ());
  g_assert_true (carousel.get_nth_page (1)->gobj () ==
                 (GtkWidget*) child3.gobj ());
  g_assert_true (carousel.get_nth_page (2)->gobj () ==
                 (GtkWidget*) child1.gobj ());
