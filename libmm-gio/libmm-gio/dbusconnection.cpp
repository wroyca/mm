...
static auto DBusConnection_Signal_giomm_callback_destroy (void *data) -> void
{
...
DBusConnection_Message_Filter_giomm_callback(
  GDBusConnection* connection, GDBusMessage* message, const gboolean incoming, void* user_data) -> GDBusMessage*
{
...
static auto DBusConnection_Message_Filter_giomm_callback_destroy (void *data) -> void
{
...
Connection::Connection(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  ...
  const Glib::RefPtr<Cancellable>& cancellable, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "stream",Glib::unwrap(stream),"guid",Glib::c_str_or_nullptr(guid),"flags",flags,"authentication-observer",Glib::unwrap(observer), nullptr))
{
  init_async(slot, cancellable);
}

Connection::Connection(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "stream",Glib::unwrap(stream),"guid",Glib::c_str_or_nullptr(guid),"flags",flags,"authentication-observer",nullptr, nullptr))
{
  init_async(slot, cancellable);
}

Connection::Connection(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  const Glib::RefPtr<AuthObserver>& observer, const SlotAsyncReady& slot, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "stream",Glib::unwrap(stream),"guid",Glib::c_str_or_nullptr(guid),"flags",flags,"authentication-observer",Glib::unwrap(observer), nullptr))
{
...
Connection::Connection(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  const SlotAsyncReady& slot, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "stream",Glib::unwrap(stream),"guid",Glib::c_str_or_nullptr(guid),"flags",flags,"authentication-observer",nullptr, nullptr))
{
...
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "address",Glib::c_str_or_nullptr(address),"flags",flags,"authentication-observer",Glib::unwrap(observer), nullptr))
{
  init_async(slot, cancellable);
}
...
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "address",Glib::c_str_or_nullptr(address),"flags",flags,"authentication-observer",nullptr, nullptr))
{
  init_async(slot, cancellable);
}
...
Connection::Connection(
  const std::string& address, const SlotAsyncReady& slot, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "address",Glib::c_str_or_nullptr(address),"flags",flags,"authentication-observer",nullptr, nullptr))
{
...
Connection::Connection(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  const Glib::RefPtr<AuthObserver>& observer, const Glib::RefPtr<Cancellable>& cancellable, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "stream",Glib::unwrap(stream),"guid",Glib::c_str_or_nullptr(guid),"flags",flags,"authentication-observer",Glib::unwrap(observer), nullptr))
{
...
Connection::Connection(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  const Glib::RefPtr<AuthObserver>& observer, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "stream",Glib::unwrap(stream),"guid",Glib::c_str_or_nullptr(guid),"flags",flags,"authentication-observer",Glib::unwrap(observer), nullptr))
{
...
Connection::Connection(
  const Glib::RefPtr<IOStream>& stream, const std::string& guid, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "stream",Glib::unwrap(stream),"guid",Glib::c_str_or_nullptr(guid),"flags",flags,"authentication-observer",nullptr, nullptr))
{
...
Connection::Connection(
  const std::string& address, const Glib::RefPtr<Cancellable>& cancellable, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "address",Glib::c_str_or_nullptr(address),"flags",flags,"authentication-observer",nullptr, nullptr))
{
...
Connection::Connection(
  const std::string& address, const Glib::RefPtr<AuthObserver>& observer, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "address",Glib::c_str_or_nullptr(address),"flags",flags,"authentication-observer",Glib::unwrap(observer), nullptr))
{
...
Connection::Connection(const std::string& address, const ConnectionFlags flags)
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
ObjectBase(nullptr),
Object(Glib::ConstructParams(connection_class_.init(), "address",Glib::c_str_or_nullptr(address),"flags",flags,"authentication-observer",nullptr, nullptr))
{
...
// static
auto Connection::create (
  const Glib::RefPtr <IOStream> &stream, const std::string &guid,
  const Glib::RefPtr <AuthObserver> &observer, const SlotAsyncReady &slot,
  const Glib::RefPtr <Cancellable> &cancellable, const ConnectionFlags flags) -> void
{
...
auto Connection::create (
  const Glib::RefPtr <IOStream> &stream, const std::string &guid,
  const SlotAsyncReady &slot, const Glib::RefPtr <Cancellable> &cancellable, const ConnectionFlags flags) -> void
{
  // Note that this does not return anything, because it is async - see
  // create_finish().
...
auto Connection::create (
  const Glib::RefPtr <IOStream> &stream, const std::string &guid,
  const Glib::RefPtr <AuthObserver> &observer, const SlotAsyncReady &slot, const ConnectionFlags flags) -> void
{
  // Note that this does not return anything, because it is async - see
  // create_finish().
...
auto Connection::create (
  const Glib::RefPtr <IOStream> &stream, const std::string &guid,
  const SlotAsyncReady &slot, const ConnectionFlags flags) -> void
{
  // Note that this does not return anything, because it is async - see
  // create_finish().
...
Connection::create_sync(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  const Glib::RefPtr<AuthObserver>& observer, const Glib::RefPtr<Cancellable>& cancellable, const ConnectionFlags flags) -> Glib::RefPtr<Connection>
{
...
auto
Connection::create_sync(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  const Glib::RefPtr<Cancellable>& cancellable, const ConnectionFlags flags) -> Glib::RefPtr<Connection>
{
...
auto
Connection::create_sync(const Glib::RefPtr<IOStream>& stream, const std::string& guid,
  const Glib::RefPtr<AuthObserver>& observer, const ConnectionFlags flags) -> Glib::RefPtr<Connection>
{
...
Connection::create_sync(
  const Glib::RefPtr<IOStream>& stream, const std::string& guid, const ConnectionFlags flags) -> Glib::RefPtr<Connection>
{
  return Glib::make_refptr_for_instance<Connection>(new Connection(stream, guid, flags));
}

// static
auto Connection::create_for_address (
...
// static
auto Connection::create_for_address (
  const std::string &address, const SlotAsyncReady &slot, const ConnectionFlags flags) -> void
{
  // Note that this does not return anything, because it is async - see
  // create_finish().
...
Connection::create_for_address_sync(
  const std::string& address, const Glib::RefPtr<Cancellable>& cancellable, const ConnectionFlags flags) -> Glib::RefPtr<Connection>
{
...
auto
Connection::create_for_address_sync(
  const std::string& address, const Glib::RefPtr<AuthObserver>& observer, const ConnectionFlags flags) -> Glib::RefPtr<Connection>
{
...
// static
auto
Connection::create_for_address_sync(const std::string& address, const ConnectionFlags flags) -> Glib::RefPtr<Connection>
{
...
// static
auto Connection::get (
  BusType bus_type, const SlotAsyncReady &slot,
...
// static
auto Connection::get (BusType bus_type, const SlotAsyncReady &slot) -> void
{
  const auto slot_copy = new SlotAsyncReady(slot);
...
auto Connection::close (const SlotAsyncReady &slot) -> void
{
  const auto slot_copy = new SlotAsyncReady(slot);
...
auto Connection::flush (const SlotAsyncReady &slot) -> void
{
  const auto slot_copy = new SlotAsyncReady(slot);
...
auto Connection::send_message_with_reply (
  const Glib::RefPtr <Message> &message, const int timeout_msec,
  const SlotAsyncReady &slot, const Glib::RefPtr <Cancellable> &cancellable) -> void
{
  const auto slot_copy = new SlotAsyncReady(slot);
...
auto Connection::send_message_with_reply (
  const Glib::RefPtr <Message> &message, const int timeout_msec, const SlotAsyncReady &slot) -> void
{
  const auto slot_copy = new SlotAsyncReady(slot);
  volatile guint32 out_serial = 0;
  g_dbus_connection_send_message_with_reply(gobj(), Glib::unwrap(message),
...
Connection::send_message_with_reply_sync(const Glib::RefPtr<Message>& message,
  const Glib::RefPtr<Cancellable>& cancellable, const gint timeout_msec) -> Glib::RefPtr<Message>
{
  volatile guint32 out_serial = 0;
  GError* gerror = nullptr;
...
auto
Connection::send_message_with_reply_sync(const Glib::RefPtr<Message>& message, const gint timeout_msec) -> Glib::RefPtr<Message>
{
  volatile guint32 out_serial = 0;
  GError* gerror = nullptr;
...
auto Connection::call (
  ...
  const Glib::ustring &bus_name, const int timeout_msec, CallFlags flags,
  const Glib::VariantType &reply_type) -> void
{
  ...
  g_dbus_connection_call(gobj(), c_str_or_nullptr(bus_name), object_path.c_str(),
...
auto Connection::call (
  const Glib::ustring &object_path, const Glib::ustring &interface_name,
  const Glib::ustring &method_name, const Glib::VariantContainerBase &parameters,
  const SlotAsyncReady &slot, const Glib::ustring &bus_name, const int timeout_msec, CallFlags flags,
  const Glib::VariantType &reply_type) -> void
{
  // Create a copy of the slot.
  // A pointer to it will be passed through the callback's data parameter
...
Connection::call_sync(const Glib::ustring& object_path, const Glib::ustring& interface_name,
  const Glib::ustring& method_name, const Glib::VariantContainerBase& parameters,
  const Glib::RefPtr<Cancellable>& cancellable, const Glib::ustring& bus_name, const int timeout_msec,
  CallFlags flags, const Glib::VariantType& reply_type) -> Glib::VariantContainerBase
{
  GError* gerror = nullptr;

  GVariant* const gvariant = g_dbus_connection_call_sync(gobj(), c_str_or_nullptr(bus_name),
  ...
  const Glib::VariantType& reply_type) -> Glib::VariantContainerBase
{
  ...
  GVariant* const gvariant =
    g_dbus_connection_call_sync(gobj(), c_str_or_nullptr(bus_name), object_path.c_str(),
      interface_name.c_str(), method_name.c_str(), const_cast<GVariant*>(parameters.gobj()),
  ...
  const Glib::VariantContainerBase &parameters) -> void
{
  ...
  g_dbus_connection_emit_signal(gobj(), c_str_or_nullptr(destination_bus_name),
  ...
  const Glib::ustring& object_path, const Glib::ustring& arg0, SignalFlags flags) -> guint
{
  ...
  return g_dbus_connection_signal_subscribe(gobj(), c_str_or_nullptr(sender), c_str_or_nullptr(interface_name), c_str_or_nullptr(member), c_str_or_nullptr(object_path), c_str_or_nullptr(arg0),
...
auto wrap(GDBusConnection* object, const bool take_copy) -> RefPtr<Gio::DBus::Connection>
{
...
auto Connection_signal_closed_callback (
  GDBusConnection *self, const gboolean p0, GError *p1, void *data) -> void
{
  using namespace Gio::DBus;
  using SlotType = sigc::slot<void(bool, const Glib::Error&)>;

  const auto obj = dynamic_cast<Connection*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
auto Connection_Class::init() -> const Class&
{
...
auto Connection_Class::class_init_function (void *g_class, void *class_data) -> void
{
...
{
  GError* gerror = nullptr;
  auto retvalue = Glib::wrap(g_bus_get_sync(static_cast<GBusType>(bus_type), Glib::unwrap(cancellable), &gerror));
  if(gerror)
    Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = nullptr;
  const auto retvalue = g_dbus_connection_close_finish(gobj(), Glib::unwrap(res), &gerror);
  if(gerror)
    Glib::Error::throw_exception(gerror);
  return retvalue;
}

auto Connection::close_sync (const Glib::RefPtr <Cancellable> &cancellable) -> void
{
  GError* gerror = nullptr;
...
auto Connection::close_sync () -> void
{
  GError* gerror = nullptr;
...
{
  GError* gerror = nullptr;
  const auto retvalue = g_dbus_connection_flush_finish(gobj(), Glib::unwrap(res), &gerror);
  if(gerror)
    Glib::Error::throw_exception(gerror);
  return retvalue;
}

auto Connection::flush_sync (const Glib::RefPtr <Cancellable> &cancellable) -> void
{
  GError* gerror = nullptr;
...
auto Connection::flush_sync () -> void
{
  GError* gerror = nullptr;
...
auto Connection::set_exit_on_close (
  const bool exit_on_close) -> void
{
...
{
  GError* gerror = nullptr;
  const auto retvalue = g_dbus_connection_send_message(gobj(), Glib::unwrap(message), static_cast<GDBusSendMessageFlags>(flags), &out_serial, &gerror);
  if(gerror)
    Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
auto Connection::start_message_processing () -> void
{
...
auto Connection::signal_unsubscribe (
  const guint subscription_id) -> void
{
  g_dbus_connection_signal_unsubscribe(gobj(), subscription_id);
}

auto Connection::remove_filter (
  const guint filter_id) -> void
{
  g_dbus_connection_remove_filter(gobj(), filter_id);
}

auto Connection::unregister_object(
  const guint registration_id) -> bool
{
  return g_dbus_connection_unregister_object(gobj(), registration_id);
}

auto Connection::unregister_subtree(
  const guint registration_id) -> bool
{
...
{
  GError* gerror = nullptr;
  const auto retvalue = g_dbus_connection_export_action_group(gobj(), object_path.c_str(), Glib::unwrap(action_group), &gerror);
  if(gerror)
    Glib::Error::throw_exception(gerror);
  return retvalue;
}

auto Connection::unexport_action_group (
  const guint export_id) -> void
{
...
{
  GError* gerror = nullptr;
  const auto retvalue = g_dbus_connection_export_menu_model(gobj(), object_path.c_str(), Glib::unwrap(menu), &gerror);
  if(gerror)
    Glib::Error::throw_exception(gerror);
  return retvalue;
}

auto Connection::unexport_menu_model (
  const guint export_id) -> void
{
