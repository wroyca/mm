...
void Editable_signal_insert_text_callback(GtkEditable* self, const char* text,int length,int* position,void* data)
{
  using namespace Gtk;
...
void Editable_signal_delete_text_callback(GtkEditable* self, gint p0,gint p1,void* data)
{
  using namespace Gtk;
