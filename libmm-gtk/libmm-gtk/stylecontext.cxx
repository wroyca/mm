...
namespace Glib
{
  ...
  auto
  wrap (GtkStyleContext* object, const bool take_copy) -> RefPtr<Gtk::StyleContext>
  {
...
namespace Gtk
{
  ...
  auto
  StyleContext_Class::init () -> const Class&
  {
    if (!gtype_)
    {
  ...
  auto
  StyleContext::set_scale (const int scale) -> void
  {
