...
namespace Gtk
{
  ...
  auto
  TreeViewColumn::set_renderer (CellRenderer& renderer,
                                const TreeModelColumnBase& column) -> void
  {
...
namespace Glib
{
  ...
  auto
  wrap (GtkTreeViewColumn* object, const bool take_copy) -> Gtk::TreeViewColumn*
  {
...
namespace Gtk
{
  ...
  auto
  TreeViewColumn_Class::init () -> const Class&
  {
    if (!gtype_)
    {
  ...
  auto
  TreeViewColumn::pack_start (CellRenderer& cell, const bool expand) -> void
  {
    gtk_tree_view_column_pack_start (gobj (), cell.gobj (), expand);
  }

  auto
  TreeViewColumn::pack_end (CellRenderer& cell, const bool expand) -> void
  {
  ...
  auto
  TreeViewColumn::set_spacing (const int spacing) -> void
  {
  ...
  auto
  TreeViewColumn::set_visible (const bool visible) -> void
  {
  ...
  auto
  TreeViewColumn::set_resizable (const bool resizable) -> void
  {
  ...
  auto
  TreeViewColumn::set_fixed_width (const int fixed_width) -> void
  {
    gtk_tree_view_column_set_fixed_width (gobj (), fixed_width);
  }

  auto
  TreeViewColumn::set_min_width (const int min_width) -> void
  {
  ...
  auto
  TreeViewColumn::set_max_width (const int max_width) -> void
  {
  ...
  auto
  TreeViewColumn::set_expand (const bool expand) -> void
  {
  ...
  auto
  TreeViewColumn::set_clickable (const bool clickable) -> void
  {
  ...
  auto
  TreeViewColumn::set_widget (Widget& widget) -> void
  {
  ...
  auto
  TreeViewColumn::set_alignment (const float xalign) -> void
  {
    gtk_tree_view_column_set_alignment (gobj (), xalign);
  }

  auto
  TreeViewColumn::set_alignment (const Align xalign) -> void
  {
  ...
  auto
  TreeViewColumn::set_reorderable (const bool reorderable) -> void
  {
  ...
  auto
  TreeViewColumn::set_sort_column (const int sort_column_id) -> void
  {
  ...
  auto
  TreeViewColumn::set_sort_indicator (const bool setting) -> void
  {
