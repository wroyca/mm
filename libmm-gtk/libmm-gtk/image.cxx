...
namespace Glib
{
  ...
  auto
  wrap (GtkImage* object, const bool take_copy) -> Gtk::Image*
  {
...
namespace Gtk
{
  ...
  auto
  Image::set_pixel_size (const int pixel_size) -> void
  {
