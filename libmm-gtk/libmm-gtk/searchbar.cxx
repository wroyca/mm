...
namespace Glib
{
  ...
  auto
  wrap (GtkSearchBar* object, const bool take_copy) -> Gtk::SearchBar*
  {
...
namespace Gtk
{
  ...
  auto
  SearchBar_Class::init () -> const Class&
  {
    if (!gtype_)
    {
  ...
  auto
  SearchBar::set_search_mode (const bool search_mode) -> void
  {
  ...
  auto
  SearchBar::set_show_close_button (const bool visible) -> void
  {
