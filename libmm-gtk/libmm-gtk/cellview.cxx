...
namespace Glib
{
  ...
  auto
  wrap (GtkCellView* object, const bool take_copy) -> Gtk::CellView*
  {
...
namespace Gtk
{
  ...
  auto
  CellView_Class::init () -> const Class&
  {
    if (!gtype_)
    {
  ...
  auto
  CellView::set_draw_sensitive (const bool draw_sensitive) -> void
  {
  ...
  auto
  CellView::set_fit_model (const bool fit_model) -> void
  {
