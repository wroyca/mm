...
namespace Glib
{
  ...
  auto
  wrap (GtkPopoverMenuBar* object, const bool take_copy) -> Gtk::PopoverMenuBar*
  {
...
namespace Gtk
{
  ...
  auto
  PopoverMenuBar_Class::init () -> const Class&
  {
    if (!gtype_)
    {
  ...
  PopoverMenuBar::PopoverMenuBar (
    ...
    : ObjectBase (nullptr),
      Widget (Glib::ConstructParams (popovermenubar_class_.init (),
                                     "menu_model",
