...
#ifndef G_OS_WIN32
  auto
  gtk_page_setup_unix_dialog_get_type (void) -> GType;
#endif
  auto
...
#ifndef G_OS_WIN32
  auto
  gtk_printer_get_type (void) -> GType;
#endif
#ifndef G_OS_WIN32
  auto
  gtk_print_job_get_type (void) -> GType;
#endif
  auto
...
#ifndef G_OS_WIN32
  auto
  gtk_print_unix_dialog_get_type (void) -> GType;
#endif
  auto
...
namespace Gtk
{
  ...
  wrap_init () -> void
  {
    ...
    wrap_register (gtk_app_chooser_button_get_type (),
                   &AppChooserButton_Class::wrap_new);
    wrap_register (gtk_app_chooser_dialog_get_type (),
                   &AppChooserDialog_Class::wrap_new);
    wrap_register (gtk_app_chooser_widget_get_type (),
                   &AppChooserWidget_Class::wrap_new);
    wrap_register (gtk_application_get_type (), &Application_Class::wrap_new);
    wrap_register (gtk_application_window_get_type (),
    ...
    wrap_register (gtk_assistant_page_get_type (),
    ...
    wrap_register (gtk_builder_cscope_get_type (),
    ...
    wrap_register (gtk_cell_area_context_get_type (),
                   &CellAreaContext_Class::wrap_new);
    wrap_register (gtk_cell_renderer_get_type (),
                   &CellRenderer_Class::wrap_new);
    wrap_register (gtk_cell_renderer_accel_get_type (),
                   &CellRendererAccel_Class::wrap_new);
    wrap_register (gtk_cell_renderer_combo_get_type (),
                   &CellRendererCombo_Class::wrap_new);
    wrap_register (gtk_cell_renderer_pixbuf_get_type (),
                   &CellRendererPixbuf_Class::wrap_new);
    wrap_register (gtk_cell_renderer_progress_get_type (),
                   &CellRendererProgress_Class::wrap_new);
    wrap_register (gtk_cell_renderer_spin_get_type (),
                   &CellRendererSpin_Class::wrap_new);
    wrap_register (gtk_cell_renderer_spinner_get_type (),
                   &CellRendererSpinner_Class::wrap_new);
    wrap_register (gtk_cell_renderer_text_get_type (),
                   &CellRendererText_Class::wrap_new);
    wrap_register (gtk_cell_renderer_toggle_get_type (),
    ...
    wrap_register (gtk_center_layout_get_type (),
    ...
    wrap_register (gtk_directory_list_get_type (),
    ...
    wrap_register (gtk_drop_controller_motion_get_type (),
    ...
    wrap_register (gtk_drop_target_async_get_type (),
                   &DropTargetAsync_Class::wrap_new);
    wrap_register (gtk_editable_label_get_type (),
                   &EditableLabel_Class::wrap_new);
    wrap_register (gtk_emoji_chooser_get_type (),
    ...
    wrap_register (gtk_entry_completion_get_type (),
                   &EntryCompletion_Class::wrap_new);
    wrap_register (gtk_event_controller_get_type (),
                   &EventController_Class::wrap_new);
    wrap_register (gtk_event_controller_focus_get_type (),
                   &EventControllerFocus_Class::wrap_new);
    wrap_register (gtk_event_controller_key_get_type (),
                   &EventControllerKey_Class::wrap_new);
    wrap_register (gtk_event_controller_legacy_get_type (),
                   &EventControllerLegacy_Class::wrap_new);
    wrap_register (gtk_event_controller_motion_get_type (),
                   &EventControllerMotion_Class::wrap_new);
    wrap_register (gtk_event_controller_scroll_get_type (),
                   &EventControllerScroll_Class::wrap_new);
    wrap_register (gtk_expander_get_type (), &Expander_Class::wrap_new);
    wrap_register (gtk_file_chooser_dialog_get_type (),
                   &FileChooserDialog_Class::wrap_new);
    wrap_register (gtk_file_chooser_native_get_type (),
                   &FileChooserNative_Class::wrap_new);
    wrap_register (gtk_file_chooser_widget_get_type (),
    ...
    wrap_register (gtk_grid_layout_child_get_type (),
    ...
    wrap_register (gtk_icon_paintable_get_type (),
    ...
    wrap_register (gtk_layout_manager_get_type (),
    ...
    wrap_register (gtk_list_item_factory_get_type (),
    ...
    wrap_register (gtk_media_controls_get_type (),
    ...
    wrap_register (gtk_message_dialog_get_type (),
    ...
    wrap_register (gtk_notebook_page_get_type (),
                   &NotebookPage_Class::wrap_new);
    wrap_register (gtk_numeric_sorter_get_type (),
                   &NumericSorterBase_Class::wrap_new);
    wrap_register (gtk_overlay_get_type (), &Overlay_Class::wrap_new);
    wrap_register (gtk_pad_controller_get_type (),
    ...
    wrap_register (gtk_password_entry_get_type (),
    ...
    wrap_register (gtk_popover_menu_bar_get_type (),
                   &PopoverMenuBar_Class::wrap_new);
    wrap_register (gtk_print_context_get_type (),
...
#endif
    wrap_register (gtk_print_operation_get_type (),
                   &PrintOperation_Class::wrap_new);
    wrap_register (gtk_print_settings_get_type (),
    ...
    wrap_register (gtk_recent_manager_get_type (),
    ...
    wrap_register (gtk_scrolled_window_get_type (),
    ...
    wrap_register (gtk_selection_filter_model_get_type (),
    ...
    wrap_register (gtk_shortcut_action_get_type (),
                   &ShortcutAction_Class::wrap_new);
    wrap_register (gtk_nothing_action_get_type (),
                   &NothingAction_Class::wrap_new);
    wrap_register (gtk_callback_action_get_type (),
                   &CallbackAction_Class::wrap_new);
    wrap_register (gtk_mnemonic_action_get_type (),
                   &MnemonicAction_Class::wrap_new);
    wrap_register (gtk_activate_action_get_type (),
                   &ActivateAction_Class::wrap_new);
    wrap_register (gtk_signal_action_get_type (),
                   &SignalAction_Class::wrap_new);
    wrap_register (gtk_named_action_get_type (), &NamedAction_Class::wrap_new);
    wrap_register (gtk_shortcut_controller_get_type (),
                   &ShortcutController_Class::wrap_new);
    wrap_register (gtk_shortcut_label_get_type (),
                   &ShortcutLabel_Class::wrap_new);
    wrap_register (gtk_shortcuts_group_get_type (),
                   &ShortcutsGroup_Class::wrap_new);
    wrap_register (gtk_shortcuts_section_get_type (),
                   &ShortcutsSection_Class::wrap_new);
    wrap_register (gtk_shortcuts_shortcut_get_type (),
                   &ShortcutsShortcut_Class::wrap_new);
    wrap_register (gtk_shortcuts_window_get_type (),
                   &ShortcutsWindow_Class::wrap_new);
    wrap_register (gtk_shortcut_trigger_get_type (),
                   &ShortcutTrigger_Class::wrap_new);
    wrap_register (gtk_never_trigger_get_type (),
                   &NeverTrigger_Class::wrap_new);
    wrap_register (gtk_keyval_trigger_get_type (),
                   &KeyvalTrigger_Class::wrap_new);
    wrap_register (gtk_mnemonic_trigger_get_type (),
                   &MnemonicTrigger_Class::wrap_new);
    wrap_register (gtk_alternative_trigger_get_type (),
                   &AlternativeTrigger_Class::wrap_new);
    wrap_register (gtk_signal_list_item_factory_get_type (),
                   &SignalListItemFactory_Class::wrap_new);
    wrap_register (gtk_single_selection_get_type (),
                   &SingleSelection_Class::wrap_new);
    wrap_register (gtk_size_group_get_type (), &SizeGroup_Class::wrap_new);
    wrap_register (gtk_slice_list_model_get_type (),
    ...
    wrap_register (gtk_sort_list_model_get_type (),
    ...
    wrap_register (gtk_text_child_anchor_get_type (),
    ...
    wrap_register (gtk_tree_view_column_get_type (),
