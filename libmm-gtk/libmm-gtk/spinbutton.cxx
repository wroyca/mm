...
namespace Gtk
{
  ...
  SpinButton::SpinButton (const double climb_rate, const guint digits)
    : ObjectBase (nullptr),
      Widget (Glib::ConstructParams (spinbutton_class_.init (),
                                     "climb_rate",
                                     climb_rate,
                                     "digits",
                                     digits,
...
namespace
{
  ...
  SpinButton_signal_input_callback (GtkSpinButton* self, double* p0, void* data) -> gint
  {
    ...
    const auto obj = dynamic_cast<SpinButton*> (
...
namespace Glib
{
  ...
  auto
  wrap (GtkSpinButton* object, const bool take_copy) -> Gtk::SpinButton*
  {
...
namespace Gtk
{
  ...
  auto
  SpinButton_Class::init () -> const Class&
  {
    if (!gtype_)
    {
  ...
  auto
  SpinButton::set_digits (const guint digits) -> void
  {
  ...
  auto
  SpinButton::set_increments (const double step, const double page) -> void
  {
  ...
  auto
  SpinButton::set_range (const double min, const double max) -> void
  {
  ...
  auto
  SpinButton::set_value (const double value) -> void
  {
  ...
  auto
  SpinButton::set_numeric (const bool numeric) -> void
  {
  ...
  auto
  SpinButton::spin (SpinType direction, const double increment) -> void
  {
  ...
  auto
  SpinButton::set_wrap (const bool wrap) -> void
  {
  ...
  auto
  SpinButton::set_snap_to_ticks (const bool snap_to_ticks) -> void
  {
  ...
  auto
  SpinButton::set_climb_rate (const double climb_rate) -> void
  {
