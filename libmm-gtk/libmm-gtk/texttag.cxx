...
namespace Glib
{
  ...
  auto
  wrap (GtkTextTag* object, const bool take_copy) -> RefPtr<Gtk::TextTag>
  {
    return Glib::make_refptr_for_instance<Gtk::TextTag> (
        dynamic_cast<Gtk::TextTag*> (wrap_auto ((GObject*) object, take_copy)));
  }
...
namespace Gtk
{
  ...
  auto
  TextTag_Class::init () -> const Class&
  {
    if (!gtype_)
    {
  ...
  auto
  TextTag::set_priority (const int priority) -> void
  {
    gtk_text_tag_set_priority (gobj (), priority);
  }

  auto
  TextTag::tag_changed (const bool size_changed) -> void
  {
