...
namespace Gdk::Cairo
{
  ...
  auto
  wrap (cairo_t* cobject, const bool has_reference) -> ::Cairo::RefPtr<::Cairo::Context>
  {
  ...
  auto
  wrap (cairo_region_t* cobject, const bool has_reference) -> ::Cairo::RefPtr<::Cairo::Region>
  {
