...
{
  auto
  gdk_app_launch_context_get_type (void) -> GType;
  auto
  gdk_cairo_context_get_type (void) -> GType;
  auto
  gdk_clipboard_get_type (void) -> GType;
  auto
  gdk_content_provider_get_type (void) -> GType;
  auto
  gdk_cursor_get_type (void) -> GType;
  auto
  gdk_device_get_type (void) -> GType;
  auto
  gdk_device_tool_get_type (void) -> GType;
  auto
  gdk_display_get_type (void) -> GType;
  auto
  gdk_display_manager_get_type (void) -> GType;
  auto
  gdk_drag_get_type (void) -> GType;
  auto
  gdk_draw_context_get_type (void) -> GType;
  auto
  gdk_drop_get_type (void) -> GType;
  auto
  gdk_frame_clock_get_type (void) -> GType;
  auto
  gdk_gl_context_get_type (void) -> GType;
  auto
  gdk_gl_texture_get_type (void) -> GType;
  auto
  gdk_memory_texture_get_type (void) -> GType;
  auto
  gdk_monitor_get_type (void) -> GType;
  auto
  gdk_pixbuf_get_type (void) -> GType;
  auto
  gdk_pixbuf_animation_get_type (void) -> GType;
  auto
  gdk_pixbuf_animation_iter_get_type (void) -> GType;
  auto
  gdk_pixbuf_loader_get_type (void) -> GType;
  auto
  gdk_seat_get_type (void) -> GType;
  auto
  gdk_snapshot_get_type (void) -> GType;
  auto
  gdk_surface_get_type (void) -> GType;
  auto
  gdk_texture_get_type (void) -> GType;

  auto
  gdk_gl_error_quark (void) -> GQuark;
  auto
  gdk_pixbuf_error_quark (void) -> GQuark;
  auto
